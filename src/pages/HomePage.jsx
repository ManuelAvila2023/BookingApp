...
const HomePage = () => {
  ...
  useEffect(() => {
    const url = "/hotels"; // Ruta relativa
    dispatch(getHotelsThunk(url));
  }, []);

  const cbFilter = (hotel) => {
    const filterName = hotel.name.toLowerCase().includes(nameSearched.toLowerCase());
...
//   useEffect(() => {
//     const url = "https://hotels-api.academlo.tech/hotels"; // URL absoluta
//     dispatch(getHotelsThunk(url));
//   }, []);
